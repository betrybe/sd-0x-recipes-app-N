...
describe('70 - Todos os elementos devem respeitar os atributos descritos no protótipo para a tela de explorar bebidas ou comidas', () => {
...
describe('71 - A tela deve ter três botões: um para explorar por ingrediente, um para explorar por local de origem e um para pegar uma receita aleatória', () => {
...
describe('72 - Ao clicar em "Por Ingredientes", a rota deve mudar para tela de explorar ingredientes', () => {
...
describe('73 - Ao clicar em "Por Local de Origem", a rota deve mudar para tela de explorar por local de origem', () => {
...
describe('74 - Ao clicar em "Me Surpreenda!", a rota deve mudar para a tela de detalhes de uma receita, que deve ser escolhida de forma aleatória através da API', () => {
