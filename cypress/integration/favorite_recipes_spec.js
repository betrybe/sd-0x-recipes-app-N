...
describe('Favorite recipes screen', () => {
  ...
  describe('60 - Todos os elementos devem respeitar os atributos descritos no protótipo para a tela de receitas favoritas', () => {
  ...
  describe('61 - Caso a receita do card seja uma comida, ela deve possuir: a foto da receita, o nome, a categoria, a area, um botão de compartilhar e um de "desfavoritar"', () => {
  ...
  describe('62 - Caso a receita do card seja uma bebida, ela deve possuir: a foto da receita, o nome, se é alcoólica ou não, um botão de compartilhar e um de "desfavoritar"', () => {
  ...
  describe('63 - O botão de compartilhar deve copiar a URL da tela de detalhes da receita para o clipboard', () => {
  ...
  describe('64 - O botão de "desfavoritar" deve remover a receita da lista de receitas favoritas do localStorage e da tela', () => {
  ...
  describe('65 - Devem existir 2 botões que filtram as receitas por comida ou bebida e um terceiro que remove todos os filtros', () => {
  ...
  describe('66 - Ao clicar na foto ou no nome da receita, a rota deve mudar para a tela de detalhes daquela receita', () => {
