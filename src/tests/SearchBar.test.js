...
describe('SearchBar tests', () => {
  ...
  describe('tests with meals', () => {
    ...
    test('if search with Orange and radio name working and change route to /comidas/:id-da-receita', async () => {
      const { queryByTestId, history } = renderWithRouter(
        <RecipesAppProvider>
          <SearchBar recipeType="Comidas" />
        </RecipesAppProvider>,
      ...
      expect(history.location.pathname).toBe('/comidas/52970');
    });
  ...
  describe('tests with drinks', () => {
    ...
    test('if search with Orange and radio name working and change route to /bebidas/:id', async () => {
      const { queryByTestId, history } = renderWithRouter(
        <RecipesAppProvider>
          <SearchBar recipeType="Bebidas" />
        </RecipesAppProvider>,
      ...
      expect(history.location.pathname).toBe('/bebidas/52970');
    });
