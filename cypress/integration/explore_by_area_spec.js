...
describe('78 - Todos os elementos devem respeitar os atributos descritos no protótipo para a tela de explorar por local de origem', () => {
...
describe('79 - A tela segue as mesmas especificações da tela de receitas principal, a única diferença é que os filtros de categoria são substituídos por um dropdown', () => {
...
describe('80 - No dropdown devem estar disponíveis todas as áreas retornadas da API, incluindo a opção "All", que retorna as receitas sem nenhum filtro', () => {
...
describe('81 - A rota /explorar/bebidas/area não deve estar disponível', () => {
