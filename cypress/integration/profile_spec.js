...
describe('Profile screen', () => {
  ...
  describe('82 - Todos os elementos devem respeitar os atributos descritos no protótipo para a tela de perfil', () => {
  ...
  describe('83 - O e-mail da pessoa usuária deve estar visível', () => {
    it('O e-mail armazenado em localStorage está visível', () => {
      cy.get('[data-testid="profile-email"]').contains('email@mail.com');
    });
  });

  describe('84 - Essa tela deve conter 3 botões: um de nome "Receitas Feitas", um de nome "Receitas Favoritas" e um de nome "Sair"', () => {
  ...
  describe('85 - Ao clicar no botão de "Receitas Favoritas", a rota deve mudar para a tela de receitas favoritas', () => {
  ...
  describe('86 - Ao clicar no botão de "Receitas Feitas", a rota deve mudar para a tela de receitas feitas', () => {
    it('Redireciona para a rota correta', () => {
  ...
  describe('87 - Ao clicar no botão de "Sair", o `localStorage` deve ser limpo e a rota deve mudar para a tela de login', () => {
