...
describe('Done recipes screen', () => {
  ...
  describe('54 - Todos os elementos devem respeitar os atributos descritos no protótipo para a tela de receitas feitas', () => {
  ...
  describe('55 - Caso a receita do card seja uma comida, ela deve possuir: a foto da receita, o nome, a categoria, a area, a data em que a pessoa fez a receita, as 2 primeiras tags retornadas pela API e um botão de compartilhar', () => {
  ...
  describe('56 - Caso a receita do card seja uma bebida, ela deve possuir: a foto da receita, o nome, se é alcoólica, a data em que a pessoa fez a receita e um botão de compartilhar', () => {
  ...
  describe('57 - O botão de compartilhar deve copiar a URL da tela de detalhes da receita para o clipboard', () => {
  ...
  describe('58 - Devem existir 2 botões que filtram as receitas por comida ou bebida e um terceiro que remove todos os filtros', () => {
  ...
  describe('59 - Ao clicar na foto ou no nome da receita, a rota deve mudar para a tela de detalhes daquela receita', () => {
